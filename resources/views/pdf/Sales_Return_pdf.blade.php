...
<html lang="en">
   <head>
      <meta charset="utf-8">
      <title>Sale Return Detail</title>
   ...
   <body>
      <header class="clearfix">
         ...
         <div id="Title-heading">
             Sale Return Detail {{$return_sale['Ref']}}
         </div>
      </header>
      <main>
         <div class="col-head">
            <div class="rightDiv">
               <p><strong>Customer Info:</strong></p>
                <table>
                    <tr>
                        <td>Name:</td>
                        <td>{{$return_sale['client_name']}}</td>
                    </tr>
                     <tr>
                        <td>Address :</td>
                        <td>{{$return_sale['client_adr']}}</td>
                    </tr>
                     <tr>
                        <td>Phone :</td>
                        <td>{{$return_sale['client_phone']}}</td>
                    </tr>
                     <tr>
                        <td>Mail :</td>
                        <td>{{$return_sale['client_email']}}</td>
                    </tr>
