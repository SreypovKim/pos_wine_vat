        ...
        <ul class="navigation-left">
          ...
          <li
            v-show="currentUserPermissions && (currentUserPermissions.includes('setting_system') 
                        ...
                        || currentUserPermissions.includes('currency')  || currentUserPermissions.includes('exchange_rate')
                        || currentUserPermissions.includes('category')  || currentUserPermissions.includes('plt_rate')
          ...
          <li
            v-show="currentUserPermissions && 
                     ...
                     || currentUserPermissions.includes('Reports_sale_payment_alerts')
      ...
      <div ref="sidebarChild">
        ...
        >
          ...
          >
           ...
           <li
            class="nav-item">
            <router-link tag="a" class to="/app/settings/SubCategories">
              <i class="nav-icon i-Data-Backup"></i>
              <span class="item-name">{{$t('SubCategories')}}</span>
            </router-link>
          </li>
           <li
            class="nav-item">
            <router-link tag="a" class to="/app/settings/PaymentTerms">
              <i class="nav-icon i-Data-Backup"></i>
              <span class="item-name">{{$t('PaymentTerms')}}</span>
            </router-link>
          </li>
           <li
            class="nav-item">
            <router-link tag="a" class to="/app/settings/Actions">
              <i class="nav-icon i-Data-Backup"></i>
              <span class="item-name">{{$t('PaymentAction')}}</span>
            </router-link>
          </li>
          <li
            class="nav-item"
          ...
          <li
            class="nav-item"
            v-if="currentUserPermissions && currentUserPermissions.includes('currency')">
            <router-link tag="a" class to="/app/settings/Exchange_Rate">
              <i class="nav-icon i-Dollar-Sign"></i>
              <span class="item-name">{{$t('ExchangeRate')}}</span>
            </router-link>
          </li>
          ...
          <li
            class="nav-item"
            v-if="currentUserPermissions && currentUserPermissions.includes('currency')">
            <router-link tag="a" class to="/app/settings/PLT_Rate">
              <i class="nav-icon i-Dollar-Sign"></i>
              <span class="item-name">{{$t('PLTRate')}}</span>
            </router-link>
          </li>
            ...
            <!-- <li
            class="nav-item">
            <router-link tag="a" class to="/app/settings/Services">
              <i class="nav-icon i-Quotes"></i>
        ...
        >
          ...
          <!-- <li
            class="nav-item"
            v-if="currentUserPermissions && currentUserPermissions.includes('Reports_sale_payment_alerts')">
            <router-link tag="a" class to="/app/reports/sale_payment_alerts">
              <i class="nav-icon i-Dollar"></i>
              <span class="item-name">{{$t('ProductQuantityAlerts')}}</span>
            </router-link>
          </li> -->
