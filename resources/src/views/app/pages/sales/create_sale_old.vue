                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        <tr v-for="detail  in details">
                          ...
                          <td>{{currentUser.currency}}{{formatNumber(detail.Net_price)}}</td>
                          <td>
                            <span
                          ...
                          <td>{{currentUser.currency}}{{formatNumber(detail.DiscountNet * detail.quantity)}}</td>
                          <td>{{currentUser.currency}}{{formatNumber(detail.taxe  * detail.quantity)}}</td>
