            ...
            <div class="main-header">
              <div class="logo">
                <router-link to="/app/dashboard">
                  <img :src="'/images/'+currentUser.logo" alt width="90" height="90">
                </router-link>
              </div>
                  ...
                  >
                    ...
                    >
                      <div class="menu-icon-grid">
                        ...
                        <a @click="SetLocal('es')">
                          <i title="es" class="flag-icon flag-icon-squared flag-icon-kh"></i>
                          <span class="title-lang">Khmer</span>
                        </a>
                  ...
                  <div class="footer_panel">
                    <b-row>
                      ...
                      <!-- <b-col lg="3" md="3" sm="12">
                        ...
                        >
                          <b-form-group :label="$t('PLT')" append="%">
                            <b-input-group :append="currentUser.currency">
                              <b-form-input
                                :state="getValidationState(validationContext)"
                                aria-describedby="PLT-feedback"
                                label="PLT"
                                v-model.number="sale.plt"
                                @keyup="keyup_PLT()"
                              ></b-form-input>
                            </b-input-group>
            ...
            <b-row>
              ...
              <div class="col-md-12 d-flex flex-row flex-wrap bd-highlight list-item mt-2">
                <div
                  ...
                  v-if="product.qte_sale >= product.VariantQty || !product.product_variant_id"
                ...
                >
                  ...
                  <div class="flex-grow-1 d-bock">
                    ...
                    >
                      ...
                      <!-- <div class="w-40 w-sm-100 item-title">{{product.kh_name}}</div> -->
                      <!-- <div class="w-40 w-sm-100 item-title">{{product.code}}</div> -->
                      <span
                        class="badge badge-primary w-15 w-sm-100 mb-2"
                      >{{currentUser.currency}} {{formatNumber(product.Net_price , 2)}}</span>
                        <span
                        class="badge badge-primary w-15 w-sm-100 mb-2"
                      >{{Size}} {{product.Variant}}</span>
                      <p
                        class="m-0 text-muted text-small w-15 w-sm-100 d-none d-lg-block item-badges"
                      >
                        <!-- <span
                          class="badge badge-info"
                        >{{formatNumber(product.qte_sale  , 2)}} {{product.Variant}}</span> -->
                        <span
                          class="badge badge-info"
                        >{{parseInt(product.product_qty)}} {{product.Variant}}</span>
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div style="max-width:400px;margin:0px auto">
            ...
            <div style="font-size: 8px; margin-top: 0px;">
              ...
              <div style="display: flex; justify-content: space-between; margin-top: -2px; font-size: 8px;">
                <div style="font-size: 9px;"><span style=" font-family:'KhmerOScontent', sans-serif;">អាករបំភ្លឺសាធារណៈ</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; PLT {{ formatNumber(parseFloat(plt_rates.plt_rate),0) }}% &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</div>
                        ...
                        <b-form-group slot-scope="{ valid, errors }" :label="$t('Paymentchoice')">
                          <v-select
                            ...
                            :options="
                              ...
                              {label: 'Phillip Bank', value: 'Phillip Bank'},
                              ]"
                          ></v-select>
                          <b-form-invalid-feedback>{{ errors[0] }}</b-form-invalid-feedback>
                        </b-form-group>
                  ...
                  <b-card>
                    <b-list-group>
                      ...
                      <b-list-group-item class="d-flex justify-content-between align-items-center">
                        ...
                        <span
                          class="font-weight-bold"
                        >{{currentUser.currency}} {{ formatNumber(sub_after_plt,2)}} ({{plt_rates.plt_rate}} %)</span>
                      </b-list-group-item>
  ...
  methods: {
        ...
        if (!success) {
          ...
          this.makeToast(
            ...
            if (this.payment.amount > this.payment.received_amount) {
              ...
              //   if (detail.is_combine === 1) {
              //     const matchingCombines = this.combines.filter(
              //         combine => combine.product_id ===  detail.product_id
              //     );
                  
              //   if (matchingCombines.length > 0) {
              //       const combinedQty = matchingCombines.reduce((total, combine) => total + (detail.quantity * combine.qty), 0);
              //       const combileDetail = matchingCombines.reduce((combine) => combine.product_combine_id);
              //       console.log([combinedQty,combileDetail]);
        ...
        if (this.details.length > 0) {
         ...
         var value = this.details.find((details) => details.product_id == this.product.product_id);
          ...
          if(value){
            ...
            if(this.product.current / this.product.ProductVariantQty >= this.product.ProductVariantQty && this.product.is_stock == 1 ){
    ...
    Invoice_POS(id) {
      ...
      axios
        ...
        .then(response => {
          ...
          this.sub_after_dis = response.data.sub_after_dis;
    ...
    Get_Product_Details(product, product_id) {
      axios.get("Products/" + product_id).then(response => {
        ...
        var Unit_price = response.data.Unit_price;
        ...
        var fix_price = response.data.fix_price;
        this.product.sale_unit_id = response.data.sale_unit_id;
        var VariantQty =  response.data.VariantQty;
        ...
        if(this.product.product_variant_id){
            ...
            this.product.Net_price =  response.data.price;
              this.product.Unit_price =  response.data.price ? response.data.price : Unit_price;
              this.product.fix_price =  response.data.price ? response.data.price : fix_price;
              this.product.Total_price = response.data.price ? response.data.price : Total_price;
              this.product.ProductVariantQty = response.data.qty;
              this.product.product_qty = this.product.current / response.data.qty;
          ...
          this.product.Net_price = Net_price;
              ...
              this.product.fix_price =  fix_price;
              this.product.Total_price = Total_price;
    ...
    CaclulTotal() {
      ...
      this.sub_after_plt = parseFloat(
        (total_without_discount * (this.plt_rates.plt_rate / 100)).toFixed(2)
      );
     
      this.GrandTotal = parseFloat(
         total_without_discount + this.sale.TaxNet + this.sale.shipping + this.sub_after_plt
      );

      console.log(this.GrandTotal);
      console.log(this.sub_after_plt);

      var grand_total =  this.GrandTotal.toFixed(2);
      this.GrandTotal = parseFloat(grand_total);

      //this.totalriel = parseFloat(grand_total) * parseFloat(this.totalriel);
      // alert(this.totalriel);
      ...
      for (var i = 0; i < this.details.length; i++) {
        if (this.details[i].detail_id === id) {
          if (isNaN(detail.quantity)) {
            ...
            if(detail.quantity > detail.current && this.details[i].is_combine == 1){
              ...
              if(relatedCombines.length > 0){
                relatedCombines.forEach(combine => {  
                  ...
                  if(relatedItem){
                    ...
                    let find_qty_item =(this.details[i].current-(relatedItem.quantity *combine.qty))/Item.ProductVariantQty;
                      ...
                      if(!this.details[i].product_qty){
                        this.details[i].product_qty=this.details[i].current;
                      }
                      if(this.details[i].quantity >=  parseInt(this.details[i].product_qty)){
                        this.makeToast("warning", this.$t("LowStock"), this.$t("Warning"));
                        this.details[i].quantity =  parseInt(this.details[i].product_qty);
        ...
        if (this.details[i].code === code) {
          ...
          this.makeToast("warning", this.$t("LowStock"), this.$t("Warning")); 
            ...
            if(this.details[i].is_combine == 1){
              axios.get("Products/Products_combine_qty/" + this.details[i].product_id+"/"+this.details[i].quantity)
                .then(response => {
                    this.response_mini_qty = response.data;
                    })
                  .catch(error => {
            ...
            const relatedCombines = this.combines.filter(combine => combine.product_combine_id === this.details[i].product_id);
              relatedCombines.forEach(combine => {  
                    const relatedItem = this.details.find(i => i.product_id === combine.product_id);
                        ...
                        if(relatedItem){
                            let find_qty_item =(this.details[i].current-(relatedItem.quantity *combine.qty))/Item.ProductVariantQty;
                            if(this.details[i].quantity  >= parseInt(find_qty_item -1)){
                            this.makeToast("warning", this.$t("LowStock"), this.$t("Warning"));
                            this.details[i].quantity =  parseInt(find_qty_item);
      ...
      for (var i = 0; i < this.details.length; i++) {
        if (this.details[i].detail_id == id) {
          ...
          if (this.details[i].quantity + 1 > this.details[i].current  / this.details[i].ProductVariantQty && this.details[i].is_stock == 1) {
            ...
            if(this.details[i].qty){
              this.details[i].qty =  this.details[i].quantity;
            }
            axios.get("Products/Products_combine_qty/" + this.details[i].product_id+"/"+this.details[i].quantity)
                .then(response => {
                    this.response_mini_qty = response.data;
            ...
            if( this.response_mini_qty > this.details[i].quantity && this.details[i].detail_id == id || this.response_mini_qty=="" && this.details[i].detail_id == id){
              ...
              this.makeToast("warning", this.$t("LowStock"), this.$t("Warning"));
                this.details[i].quantity =parseInt(this.response_mini_qty);

            }
          
            if(this.details[i].old_qty == 0){
              
              this.details[i].qty =  this.details[i].quantity - this.details[i].old_qty;
        ...
        if (this.details[i].detail_id == id) {
          if(detail.is_stock == 1){
              if (detail.quantity - 1 > detail.current || detail.quantity - 1 < 1 ) {
                ...
                this.details[i].quantity--;
                 if(this.details[i].old_qty){
                    this.details[i].qty =  this.details[i].old_qty - this.details[i].quantity;
                  }
    ...
    getResultValue(result) {
      // console.log(result.code + " " + "(" + result.kh_name + ")" + "(" + result.name + ")" )
      // return result.code + " " + "(" + result.kh_name + ")" + "(" + result.name + ")" ;
       return result.code + " " + "-" + "(" + result.name + ")" +" - "+ "(" + result.Variant+ ")";
    },
    ...
    SearchProduct(result) {
      ...
      this.product.kh_name = result.kh_name;
    ...
    Check_Product_Exist(product, id) {
      ...
      if (product.qte_sale < 1 && product.is_stock == 1) {
    ...
    GetElementsPos() {
      axios
        ...
        .then(response => {
          ...
          console.log(this.plt_rates.plt_rate);
