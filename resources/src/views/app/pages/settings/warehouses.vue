  ...
  <div class="main-content">
    ...
    <validation-observer ref="Create_Warehouse">
      <b-modal hide-footer size="lg" id="New_Warehouse" :title="editmode?$t('Edit'):$t('Add')">
        <b-form @submit.prevent="Submit_Warehouse" enctype="multipart/form-data">
          <b-row>
            <!-- Name -->
            <b-col md="6">
              <validation-provider
              ...
              >
                <b-form-group :label="$t('NameWarehouse')">
                  <b-form-input
            ...
            <!-- Vat -->
             <b-col md="6">
              <b-form-group :label="$t('Vat')">
                <b-form-input
                  :placeholder="$t('Enter Vat Warehouse')"
                  label="Vat"
                  v-model="warehouse.vat"
                ></b-form-input>
              </b-form-group>
            </b-col>
  ...
  methods: {
   ...
   //------------------------------ Event Upload Image -------------------------------\\
    async onFileSelected(e) {
      ...
      if (valid) {
        this.warehouse.image = e.target.files[0];
      } else {
