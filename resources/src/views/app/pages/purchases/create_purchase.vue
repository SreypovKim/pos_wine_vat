                ...
                <b-col md="12" class="mb-5">
                  ...
                  <div id="autocomplete" class="autocomplete">
                    ...
                    <ul class="autocomplete-result-list" v-show="focused">
                      <li class="autocomplete-result" v-for="product_fil in product_filter" v-if="product_fil.is_stock == 1" @mousedown="SearchProduct(product_fil)">{{getResultValue(product_fil)}}</li>
                    </ul>
                </div>
                </b-col>
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        <tr v-for="detail in details">
                          ...
                          <td>
                          <input class="form-control" name="cost" v-model="detail.Net_cost"
                            @keyup="keyup_Cost()"
                            @focus="handleFocus"
                            @blur="handleBlur" />
                          ...
                          <td>
                            ...
                            >{{parseInt(detail.product_stock)}} {{detail.variant_name}}</span>
                          </td>
                          <td>
                            <div class="quantity">
                              <b-input-group>
...
export default {
  ...
  methods: {
    ...
    getResultValue(result) {
      ...
      // return result.code + " " + "(" + result.name + ")" + "(" + result.kh_name + ")";
    },
    ...
    keyup_Cost(){
      if (isNaN(this.purchase.cost)) {
        this.purchase.cost = 0;
      } else {
        this.Calcul_Total();
      }
    },
    ...
    Create_Purchase() {
      if (this.verifiedForm()) {
        ...
        NProgress.start();
        NProgress.set(0.1);
        this.cost = document.querySelector("input[name=cost]").value
        axios
          .post("purchases", {
      ...
      axios.get("Products/" + product_id).then(response => {
        ...
        if(this.product.product_variant_id){
           axios.get("ProductVarians/"+this.product.product_variant_id).then(response => {
            ...
            this.product.product_stock = this.product.stock / response.data.qty;
            this.product.variant_name = response.data.name;
            this.add_product();
            this.Calcul_Total();
            ...
            this.product.product_stock = this.product.stock > 0 ? this.product.stock  : 0;
            this.product.variant_name = response.data.unitSale;
            this.add_product();
            this.Calcul_Total();
