...
Route::middleware(['auth:api', 'Is_Active'])->group(function () {
    ...
    Route::get("report/client_Sale_Services", "ReportController@Sales_Client_Service");
    ...
    Route::get("report/sale_due_date", "ReportController@count_due_date_alert");
    ...
    Route::get('Products/Getcombine', 'PosController@GetCombine');
    ...
    Route::get('pos/GetExchangeRate', 'PosController@GetExchangeRate');
    ...
    Route::get('Products/combine/{id}', 'ProductsController@Products_by_combine');
    Route::get('Products/Products_combine_qty/{id}/{quantity}', 'ProductsController@Products_combine_qty');
    ...
    Route::get('ProductVarians/{id}', 'ProductsController@product_varian');
    Route::get('GetProducts','ProductsController@getProduct');
    Route::get('GetProducts/{id}','ProductsController@getProductByID');
    ...
    // Route::get('subcategories', 'SubCategorieController@index')->name('subcategories');
     Route::resource('subcategories', 'SubCategorieController');
     Route::post('subcategories/delete/by_selection', 'SubCategorieController@delete_by_selection');


     //------------------------------- Payment Term--------------------------------\\
    Route::resource('paymentterms', 'PaymentTermController');
    Route::post('paymentterms/delete/by_selection', 'PaymentTermController@delete_by_selection');


    //------------------------------- Action --------------------------------\\
    Route::resource('actions', 'ActionController');
    Route::post('actions/delete/by_selection', 'ActionController@delete_by_selection');
    Route::resource('actions/all', 'ActionController@GetAction');
    //------------------------------- Units --------------------------\\
    //------------------------------------------------------------------\\
    ...
    Route::post('exchange_rate/delete/by_selection', 'ExchangeRateController@delete_by_selection');

    //------------------------------- PLT Rate --------------------------\\
    Route::resource('plt_rate', 'PltRateController');
    Route::post('plt_rate/delete/by_selection', 'PltRateController@delete_by_selection');
    ...
    Route::get('pos/GetExchangeRate', 'SalesController@GetExchangeRate');
    Route::post('sales/action/{id}', 'SalesController@updateAction');
    Route::get('sale/GetExchangeRate', 'SalesController@GetExchangeRate');
    Route::get('sale/service', 'SalesController@service');
    ...
    Route::get('Products/filter/{id}/{input}', 'ProductsController@Filter_Products');
    Route::get('ProductVarians/{id}/{name}', 'ProductsController@FindProductVarians');