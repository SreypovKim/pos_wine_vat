...
class PaymentSalesController extends BaseController
{
    ...
    public function index(request $request)
    {
        ...
        foreach ($Payments as $Payment) {
            ...
            $item['date'] = Carbon::parse($Payment->date)->format('d-m-Y');
            ...
            $item['received_amount'] = number_format($Payment->received_amount, 2, '.', '');
            ...
            try {
                ...
                if($request['montant'] > 0){
                    ...
                    if ($request['Reglement'] == 'credit card') {
                        ...
                        $PaymentSale->montant = $request['received_amount'];
